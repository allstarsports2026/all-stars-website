                        ...
                        <div className="space-y-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                ...
                                <div className="space-y-2 pt-10 border-t border-black/5">
                                    ...
                                    <input name="saleText" defaultValue={product.saleText || ""} className={inputClasses} placeholder="E.G. 20% OFF, BLACK FRIDAY" />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input name="originalPrice" type="number" step="0.01" defaultValue={product.originalPrice || ""} className={inputClasses} placeholder="45.00" />
                                </div>
                            </div>
                        </div>
                    </div>

        ...
        <div className="space-y-12">
            <div className="grid grid-cols-2 gap-x-8 gap-y-12">
                {items.map(({ icon: Icon, label, lines }) => (
                    <div
                        key={label}
                        className="group flex flex-col gap-4 transition-all col-span-1"
                    >
                        ...
                        <div className="pl-14 border-l-2 border-black/5 group-hover:border-primary/30 transition-colors">
                            {lines.map((line) => (

...
export function FeaturedCollection({ products }: FeaturedCollectionProps) {
    ...
    return (
        <section className="pt-16 md:pt-24 pb-24 px-6 bg-white border-t border-black/5">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
                    <div>
                        ...
                        <h2 className="text-2xl md:text-4xl font-black uppercase italic tracking-tighter leading-none text-secondary">

...
export function HeroCarousel() {
    ...
    return (
        <div className="w-full bg-white flex flex-col" style={{ minHeight: "100svh" }}>
            ...
            <div className="flex-grow flex flex-col lg:grid lg:grid-cols-2 overflow-hidden">
                ...
                <div
                    className={cn(
                        ...
                        "h-[55vw] min-h-[220px] max-h-[380px]",   // mobile: slightly taller for full-width feel
                        "lg:h-auto lg:max-h-none",                  // desktop: unconstrained
            ...
            {/* Navigation Bar */}
            <div className=" h-12 lg:h-20 flex items-center justify-between px-6 lg:px-20 shrink-0">
                {/* Dot Indicators */}
                ...
                <div className="flex items-center gap-2">
                    <button
                        onClick={handlePrev}
                        className="h-9 w-9 lg:h-10 lg:w-10 rounded-full  flex items-center justify-center text-secondary/40 hover:border-primary hover:text-primary transition-all active:scale-90"
